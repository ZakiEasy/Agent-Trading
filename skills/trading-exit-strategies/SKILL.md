...
description: Tactical execution for exits and trade management. Use when setting Scaling Out targets (50% TP1, 50% TP2 Mean Reversion), Step Stop Break-Even rules, and Time Stop (J+10) invalidations.
---
