---
name: trading-walk-forward-validation
description: Walk-forward backtesting and multi-decade historical crisis stress-testing. Use when evaluating trading algorithms across historical market cycles (1999-2026) without lookahead bias.
---
