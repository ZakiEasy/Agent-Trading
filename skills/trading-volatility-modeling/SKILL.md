---
name: trading-volatility-modeling
description: Volatility and price action modeling. Use when computing ATR(14) metrics, Opening Range M15 amplitude ratios (>=25% ATR), and detecting institutional liquidity sweeps.
---
