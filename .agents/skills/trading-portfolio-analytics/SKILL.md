---
name: trading-portfolio-analytics
description: Quantitative portfolio analytics and performance metrics. Use when calculating Sharpe, Sortino, Profit Factor, Max Drawdown, Expectancy, Win Rate, and trade attribution from trading journals.
---
