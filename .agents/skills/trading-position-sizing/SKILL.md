...
description: Dynamic position sizing and allocation engine. Use when computing share quantities, nominal capital allocations, maximum line limits (20-25%), and volatility-adjusted sizing.
---
