---
name: trading-mean-reversion
description: Tactical swing trading mean reversion strategy for equities. Use when analyzing price dips, Bollinger/Keltner deviations, Fibonacci retracements, or targeting mathematical return to MM20/VWAP for long-only Sharia-compliant stocks.
---

> [!NOTE]
> **Normes Stratégiques Agent Trading** :
> - Stratégie **LONG ONLY** exclusive (actions au comptant).
> - Conformité Sharia **AAOIFI** (Dette < 33%, Liquidités < 33%, Créances < 33%, Revenus impurs < 5%).
> - Gestion du risque : **R-Max <= 1.0%**, **Risque Global <= 3-4%**, **Cash Reserve 25-30%**.
> - Cibles Mean Reversion : **MM20 Daily & VWAP**, Sorties échelonnées (TP1 50%, Step Stop BE, TP2 50%).
