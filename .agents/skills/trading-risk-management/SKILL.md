...
description: Institutional risk management protocol. Use when calculating R-Max (<=1.0% per trade), portfolio global embedded risk limits (<=3-4%), cash reserve quotas (25-30%), and stop-loss placement for equity trading.
---
